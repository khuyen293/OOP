...
public class AuthorsListUserForm extends javax.swing.JFrame {

    My_classes.Author author = new My_classes.Author();
    //public String formType = "";
    public AuthorsListUserForm() {
        initComponents();
        //center the form
    ...
    private void jButton_Search_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Search_ActionPerformed
        ...
        String query = "SELECT * FROM authors WHERE firstName LIKE '%"+value+"%' or lastName LIKE '%"+value+"%'";
